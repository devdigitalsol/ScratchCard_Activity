!(function (t, n) {
  ...
  return (function (t) {
      ...
      var r = e(0),
        ...
        a = function (t, n, e) {
          var u,
            ...
            m = t & a.P,
            g = t & a.B,
            y = p ? r : d ? r[n] || (r[n] = {}) : (r[n] || {}).prototype,
            b = p ? o : o[n] || (o[n] = {}),
            x = b.prototype || (b.prototype = {});
          for (u in (p && (e = n), e))
            (h = ((f = !v && y && void 0 !== y[u]) ? y : e)[u]),
              (l =
                g && f
                  ? s(h, r)
                  : m && "function" == typeof h
      ...
      (e(2).inspectSource = function (t) {
        ...
        (t.exports = function (t, n, e, s) {
          ...
          u && (i(e, "name") || o(e, "name", n)),
            t[n] !== e &&
              (u && (i(e, c) || o(e, c, t[n] ? "" + t[n] : a.join(String(n)))),
              t === r
                ? (t[n] = e)
                : s
                ? t[n]
        ...
        "process" == e(8)(h)
          ...
          : (r =
              "onreadystatechange" in u("script")
                ? function (t) {
                    a.appendChild(u("script")).onreadystatechange =
                      function () {
        ...
        function (t, n, e, h, l) {
          ...
          if (i(g)) {
            for (v = s(t.length); v > b; b++)
              if (
                (m = n ? y(c((p = t[b]))[0], p[1]) : y(t[b])) === u ||
                m === f
              )
                return m;
          } else
            for (d = g.call(t); !(p = d.next()).done; )
              if ((m = o(d, y, p.value, n)) === u || m === f) return m;
        }).BREAK = u),
        (n.RETURN = f);
    },
    function (t, n, e) {
    ...
    function (t, n, e) {
      ...
      t.exports =
        ...
        e(17)(function () {
          ...
          ? function (t, n) {
              for (
                var e = s(t), u = arguments.length, f = 1, h = i.f, l = c.f;
                u > f;
                ...
                for (
                  var v,
                    p = a(arguments[f++]),
                    d = h ? o(p).concat(h(p)) : o(p),
                    m = d.length,
                    g = 0;
                  m > g;

                )
                  (v = d[g++]), (r && !l.call(p, v)) || (e[v] = p[v]);
              return e;
            }
          : u;
    },
    ...
    function (t, n, e) {
      ...
      t.exports = function (t, n) {
        var e,
          ...
          a = 0,
          u = [];
        for (e in s) e != c && r(s, e) && u.push(e);
        for (; n.length > a; ) r(s, (e = n[a++])) && (~i(u, e) || u.push(e));
        return u;
      };
    },
    function (t, n, e) {
    ...
    function (t, n, e) {
      var r = e(14);
      r(r.P, "Array", { fill: e(64) }), e(65)("fill");
    },
    function (t, n, e) {
      "use strict";
      var r = e(33),
    ...
    function (t, n, e) {
                ...
                },
                {
                  ...
                  value: function (t) {
                    (this.ctx.filter = "blur(1px)"),
                      this.ctx.lineTo(this.mouseX + t, this.mouseY + t),
                      this.ctx.stroke();
                  },
                },
              ]),
        ...
        return new Promise(function (n, e) {
          ...
          (r.crossOrigin = "Anonymous"),
            ...
            (r.onerror = function (n) {
              var r = new Error("Image ".concat(t, " is not loaded."));
              e(r);
            });
        });
      }
      ...
      var h = (function () {
        function t(n, e) {
          ...
          (this.config = Object.assign(Object.assign({}, s), e)),
            (this.scratchType = this.config.scratchType),
            (this.container = this.isString(n)
              ? document.querySelector(String(n))
              : n),
            (this.position = [0, 0]),
            (this.readyToClear = !1),
            (this.percent = 0),
            ...
            (this.brush = new a(this.ctx, this.position[0], this.position[1])),
            this.config.scratchType === r.BRUSH &&
              u(this.config.brushSrc).then(function (t) {
                o.brushImage = t;
              });
          var h = f(function (t) {
            t.preventDefault(),
              c.dispatchEvent("scratch", "move"),
              (c.position = c.mousePosition(t)),
              c.brush.updateMousePosition(c.position[0], c.position[1]),
              c.scratch(),
              o.config.enabledPercentUpdate && (c.percent = c.updatePercent());
          }, 16);
          this.canvas.addEventListener("mousedown", function (t) {
            t.preventDefault(),
              c._setScratchPosition(),
              c.scratchType === r.LINE &&
                ((c.position = c.mousePosition(t)),
                c.brush.updateMousePosition(c.position[0], c.position[1]),
                c.brush.startLine(c.config.clearZoneRadius)),
              c.canvas.addEventListener("mousemove", h),
              document.body.addEventListener("mouseup", function t(n) {
                c.canvas.removeEventListener("mousemove", h),
                  c.finish(),
            ...
            this.canvas.addEventListener("touchstart", function (t) {
              t.preventDefault(),
                ...
                c.scratchType === r.LINE &&
                  ...
                  c.brush.updateMousePosition(c.position[0], c.position[1]),
                  c.brush.startLine(c.config.clearZoneRadius)),
                c.canvas.addEventListener("touchmove", h),
                document.body.addEventListener("touchend", function t() {
                  c.canvas.removeEventListener("touchmove", h),
                    c.finish(),
        ...
        return (
          s()(t, [
            ...
            },
            {
              ...
              value: function () {
                this.zone = (function (t) {
                  for (
                    var n = { left: 0, top: 0 }, e = t.getBoundingClientRect();
                    t;
                  ...
                  var r = n.left - e.left,
                    o = n.top - e.top;
                  return {
                    left: r < 0 ? n.left + Math.abs(r) : n.left - Math.abs(r),
                    top: o < 0 ? n.top + Math.abs(o) : n.top - Math.abs(o),
                  };
                })(this.canvas);
              },
            },
            {
              ...
              value: function () {
                !this.callbackDone &&
                  this.percent > this.config.percentToFinish &&
                  (this.clear(),
                  (this.canvas.style.pointerEvents = "none"),
                  void 0 !== this.config.callback &&
                    ((this.callbackDone = !0), this.config.callback()));
              },
            },
            {
              key: "dispatchEvent",
            ...
            },
            {
              ...
              value: function () {
                var t = this;
                return new Promise(function (n, e) {
                  u(t.config.imageForwardSrc).then(
                    function (e) {
                      (t.scratchImage = e),
                        t.ctx.drawImage(
                          t.scratchImage,
                    ...
                    function (n) {
                      return (
                        e(n),
                        new TypeError(
                          "".concat(t.config.imageForwardSrc, " is not loaded.")
                        )
                      );
                    }
                  );
              ...
              value: function () {
                ...
                if (0 !== this.config.htmlBackground.length)
                  !(function (t, n) {
                    ...
                    r.classList.add("sc__inner");
                    var o = e.parseFromString(t, "text/html");
                    (r.innerHTML = o.body.innerHTML),
                      n.insertBefore(r, n.firstElementChild);
                  })(this.config.htmlBackground, this.container);
                else {
                  var n = document.createElement("img");
                  u(this.config.imageBackgroundSrc).then(
                    function (e) {
            ...
            },
            {
              ...
              value: function (t) {
                ...
                switch (t.type) {
                  ...
                  case "mousemove":
                    (n =
                      t.clientX - this.config.clearZoneRadius - this.zone.left),
                      (e =
                        t.clientY -
                        this.config.clearZoneRadius -
                        this.zone.top);
              ...
              value: function () {
                for (
                  ...
                  0 === n.data[r] &&
                    ...
                    t++;
                return t >= 1
                  ? (t / (this.canvas.width * this.canvas.height)) * 100
                  : 0;
              },
            },
            {
      ...
      (window.ScratchCard = h), (window.SCRATCH_TYPE = r);
    },
  ]);
});
